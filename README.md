...
- [一个现代C#游戏引擎-sbox-public](https://github.com/Facepunch/sbox-public)
...
- [Unity 插值噪声和伪随机数工具库-KlakMath](https://github.com/keijiro/KlakMath)
...
- [Unity 使用快照插值的最佳同步对象位置和选择网络库-NetworkPositionSync](https://github.com/James-Frowen/NetworkPositionSync)
...
- [Unity 显示Navite调用堆栈-UnityMixedCallstack](https://github.com/Unity-Technologies/UnityMixedCallstack)
- [Unity 通过Unity包管理器将NuGet包安装到Unity项目中的服务-UnityNuGet](https://github.com/xoofx/UnityNuGet?)
- [Unity 简单但功能强大的 git 集成-UnityWiseGit](https://github.com/NibbleByte/UnityWiseGit?)
- [Unity 简单但功能强大的SVN 集成-UnityWiseSVN](https://github.com/NibbleByte/UnityWiseSVN)
- [Unity 游戏破解方案指导-Unity-game-hacking](https://github.com/imadr/Unity-game-hacking)
...
- [Unity Android和iOS语音转文字插件-UnitySpeechToText](https://github.com/yasirkula/UnitySpeechToText?)
- [Unity 用于口型同步的资产-uLipSync](https://github.com/hecomi/uLipSync?)
- [Unity adb命令的C#封装-AdvancedSharpAdbClient](https://github.com/SharpAdb/AdvancedSharpAdbClient?)
- [Unity Unity开源package工具-openupm](https://github.com/openupm/openupm)
- [Unity Unity游戏Mod加载器-MelonLoader](https://github.com/LavaGang/MelonLoader)
